...
def parse_args():
    ...
    parser.add_argument("-t", "--type", help="train or test", type=int, default=0)
    parser.add_argument("-ckp", "--checkpoint", help="checkpoint file", required=False)
...
def build_solver(cfg, dataset):
    ...
    # 将数据集都放到一个训练引擎里面,就这样设置的,我也不知道为啥
